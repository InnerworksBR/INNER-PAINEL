import { LayoutDashboard, Building2, FileText, Users, Settings, LogOut, FileSearch, Boxes, X, UserRound, Shield, Radio } from "lucide-react";
    ...
    return (
        ...
        <aside className={`w-64 h-screen fixed md:sticky top-0 left-0 bg-slate-900 text-white p-6 flex flex-col z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
            ...
            <nav className="flex flex-col gap-2 flex-1">
                ...
                <NavLink to="/admin/agentesAdmin" className={getActiveClass} onClick={onClose}>
                    <Radio size={18} />
                    Agentes & Coletores
                </NavLink>
